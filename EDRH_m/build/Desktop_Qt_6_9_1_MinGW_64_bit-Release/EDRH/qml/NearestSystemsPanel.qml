...
Rectangle {
    ...
    property int systemsPerPage: 50
    property int currentlyShowing: 50
    ...
    ColumnLayout {
        ...
        RowLayout {
            Layout.fillWidth: true
            Layout.preferredHeight: 55  // Increased from 50 to 55
            ...
            Button {
                id: showMoreBtn
                text: "Show " + systemsPerPage + " More"
                visible: currentlyShowing < filteredSystemsModel.length
                enabled: currentlyShowing < filteredSystemsModel.length
                
                Layout.preferredWidth: 160  // Increased from 150 to 160
                Layout.preferredHeight: 40  // Increased from 35 to 40
